...
const sampleComments = [
    {
        ...
        date: '2024-01-16',
        content:
            '정말 자세한 후기 감사해요! 저도 가족여행 계획 중인데 많은 도움이 됐어요. 한라산 등반 코스 추천해주신 것도 참고할게요.',
        likes: 12,
        replies: [
            {
                id: 11,
    ...
    },
    {
        ...
        date: '2024-01-17',
        content:
            '제주도민으로서 이렇게 좋게 봐주셨다니 감사해요. 다음에 오실 때는 서쪽 지역도 가보세요. 협재해수욕장이나 한림공원도 아이들이 좋아할 거예요!',
        likes: 8,
        replies: [],
    },
    {
        ...
        replies: [
            {
                ...
                date: '2024-01-18',
                content:
                    '저희 아이들이 8살, 11살이에요. 7살이면 부모님과 함께 타는 자전거도 있으니까 충분히 가능할 것 같아요!',
                likes: 2,
            },
        ],
    },
